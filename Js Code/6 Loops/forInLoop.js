...
for (const key in myobj){   // myobj[key] = value  // for in loop is used to print the keys
...
for (const key in arr){
    console.log(arr[key]); // arr[key] = value   to access value in for in loop object[key] or arr[key]
}
